...
using DialogNd = QuickKit.Node<Dialog>;
...
public partial class DialogTree : ITree
{
    ...
    public DialogTree(string Id, INode rootNode)
    {
        this.rootNode = rootNode;
        (rootNode as DialogNd).nodeEntity = new Dialog();
    ...
    {
        this.rootNode = new DialogNd(Id, this, true);
        (rootNode as DialogNd).nodeEntity = new Dialog();
    ...
    public DialogNd TryPhaseNext(int index = 0)
    {
        ...
        currentNode = currentNode.Sons[index] as DialogNd;
        return currentNode as DialogNd;
    }
